...
export default function LoginForm() {
  ...
  return (
    ...
    >
      ...
      {/* FORM CONTENT */}
      <div className="relative z-20 w-full max-w-[500px] translate-x-[24px] -translate-y-[2px]">
        {/* Header */}
        <h1 className="text-[44px] font-bold leading-[1.08] tracking-[-0.045em] text-foreground">
          Tekrar hoş geldin
        </h1>
